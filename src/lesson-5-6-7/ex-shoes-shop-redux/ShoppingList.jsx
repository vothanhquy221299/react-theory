...
import {actUpdateQuantity, actRemoveFromShoppingList} from '../../store/actions/shoesShopActions'
...
//Ket noi den redux store, lay du lieu tu store chuyen thanh props cua component
const mapStateToProps = state =>({
    //lay state la dang dung o root cua producer
...
//connect (high order function): ket noi react component voi redux store
